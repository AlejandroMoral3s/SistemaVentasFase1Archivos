...
class Client_Interface(Frame):
    def __init__(self, root):
        ...
        # TITLE
        self.title_Label = Label(self.root, text='FORMULARIO PARA CREACION DE CLIENTES', background=self.colorFondo, fg='white', font=('Times', 20))
    ...
    def buscarRegistro(self):
        ...
        for x in self.listadoDict:
            if x['_Cliente__noDocumento'] == self.temp_BuscarUser.get():
                noId_Exist = True
