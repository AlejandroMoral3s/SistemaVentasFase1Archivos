...
class ProductosList:    
    ...
    def buscarProducto(self, descripcionAnt):    
        for Producto in self.dataJson['products']:
            if(Producto['_Producto__descripcion']==descripcionAnt):
                return Producto
        return None
    ...
    def crearProducto(self, id, descripcion, precio, iva, nota):
        if(self.buscarProducto(descripcion)!=None): 
    ...
    def editarProducto(self, descripcionAnt, descripcion, precio, iva, nota):
        prodTemp=self.buscarProducto(descripcionAnt)
        if(prodTemp!=None):
    ...
    def borrarProducto(self, descripcion):
        prodTemp = self.buscarProducto(descripcion)
        if(prodTemp!=None):
