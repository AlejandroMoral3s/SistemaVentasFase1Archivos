...
class User_Interface:
    def __init__(self, root):
        ...
        self.id_userEntry = Entry(self.root)
        ...
        self.names_entry = Entry(self.root)
        ...
        self.profileCombo = ttk.Combobox(self.root)
        ...
        self.lastNames_entry = Entry(self.root)
        ...
        self.clave_entry = Entry(self.root)
        ...
        self.confir_entry = Entry(self.root)
        ...
        self.create_btn = Button(self.root, text='Crear')
