...
class User_Interface(Frame):
    def __init__(self, root):
        ...
        # TITLE
        self.title_Label = Label(self.root, text='FORMULARIO PARA CREACION DE USUARIOS ', background=self.colorFondo, fg='white', font=('Times', 25))
        ...
        self.create_btn = Button(self.root, text='Crear', command=self.ventanaCrearUsuario, image=self.iconoCrear)
